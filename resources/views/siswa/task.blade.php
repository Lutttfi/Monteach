        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $absen->kelas }}</td>
                    <td>
                        {{ \Carbon\Carbon::parse($absen->tanggal)->timezone('Asia/Jakarta')->format('d M Y') }}
                    </td>
                    <td>{{ $absen->jam }}</td>
                    <td>
                    ...
                    <td>
                        <form action="{{ route('siswa.konfirmasi', $absen->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-primary btn-sm" onclick="return confirm('Ingin mengkonfirmasi?')">Konfirmasi</button>
                        </form>
                    </td>
                </tr>
                @empty
