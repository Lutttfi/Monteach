    ...
    <div class="d-flex">
        ...
        <nav class="sidebar text-white">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('guru.guru') ? 'active' : '' }}" href="{{ route('guru.guru') }}">
                        <span class="iconify" data-icon="tabler:user" data-width="22"></span>
                        Guru
                    </a>
                </li>
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('guru.guruPiket') ? 'active' : '' }}" href="{{ route('guru.guruPiket') }}">
        ...
        <div class="flex-grow-1">
            <div class="navbar navbar-expand-lg navbar-light bg-white">
                <div class="container-fluid d-flex justify-content-end">
                    <span class="navbar-brand me-2">{{ Auth::user()->name }}</span>
